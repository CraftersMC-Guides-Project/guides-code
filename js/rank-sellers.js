...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const applyTheme = () => {
    ...
    if (isDarkMode) {
      ...
      elementsToStyle.sellerLists.forEach(list => (list.style.backgroundColor = "rgba(17, 25, 40, 0.49);"));
      ...
      elementsToStyle.sellerLists.forEach(list => (list.style.backgroundColor = "rgba(255, 255, 255, 0.49)"));
